              ...
              <Grid item key={index} xs={12} sm={6} md={4}>
                ...
                >
                  ...
                  <CardContent sx={{ flexGrow: 1 }}>
                    ...
                    <Typography>₱{docs.price}</Typography>
                  </CardContent>
                  <CardActions>
                    {docs.isPaid ? (
                      <>
                  ...
                  {showPayPalButton && (
                    <PayPalScriptProvider
                      options={{ "client-id": "EM_5fPjeYEoW5izPQSAC8nJ_RoZeRwq6lzaIMd1VXIIXN5KhQHkAnG37vw_uoqxWayFEzwPqyDVddu6L" }}
                    >
                      <PayPalButton
