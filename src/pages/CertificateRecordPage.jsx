...
const TABLE_HEAD = [
  ...
  { id: "type", label: "Certificate Type", alignRight: false },
...
export default function CertificateRecordPage() {
  ...
  useEffect(() => {
    const fetchData = async () => {
      try {
        ...
        const docsQuery = query(collection(db, "docsData"));
  ...
  const emptyRows =
    page > 0 ? Math.max(0, (1 + page) * rowsPerPage - docsList.length) : 0;
  ...
  return (
    <>
      <Helmet>
        <title>
          {" "}
          Baptismal Record | Birhen Del Carmen Online Parish Information System{" "}
        </title>
      </Helmet>
      {loading ? (
        <Loading />
                ...
                <Table>
                  ...
                  <TableBody>
                    {sortedDocData
                      ...
                      .map((docs, index) => {
                        const selectedUser =
                          selected.indexOf(docs.childName) !== -1;
                          ...
                          >
                            <TableCell padding="checkbox">
                              <Checkbox
                                ...
                                onChange={(event) =>
                                  handleClick(event, docs.childName)
                                }
                              />
                            </TableCell>
                            ...
                            <TableCell align="left">{docs.docType}</TableCell>
                            ...
                            <TableCell align="left">
                              ...
                              <IconButton
                                size="large"
                                color="inherit"
                                onClick={() => deleteBaptistmal(docs.id)}
                              >
                                <Iconify
